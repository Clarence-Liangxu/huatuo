...
template <> struct default_hash_traits<huatuo::concrete_binding>
: public member_function_hash_traits<huatuo::concrete_binding>
{
...
template <> struct default_hash_traits<huatuo::symbolic_binding>
: public member_function_hash_traits<huatuo::symbolic_binding>
{
